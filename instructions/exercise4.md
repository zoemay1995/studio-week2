...
(http://colorpalettes.net/) for generating warm, cool, pastel or contrasting color palettes; or [https://javier.xyz/cohesive-colors/](https://javier.xyz/cohesive-colors/) for picking perfect colors based on data and classes. I also really like [https://coolors.co/](https://coolors.co/).
